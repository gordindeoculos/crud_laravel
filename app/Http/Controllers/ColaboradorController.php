...
class ColaboradorController extends Controller
{
    ...
    {
        // Busca o colaborador pelo ID ou retorna erro 404
        $colaborador = Colaborador::findOrFail($id);

        // Retorna a view de edição, passando o colaborador como variável
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->back()->with('msg', 'Ocorreu um erro ao atualizar o registro.')
                ->with('msg_type', 'error');
        }
    }
